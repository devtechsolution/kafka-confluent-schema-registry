...
public class CoffeeOrderConsumerSchemaRegistryGenericRecord {

    private static final Logger log= LoggerFactory.getLogger(CoffeeOrderConsumerSchemaRegistryGenericRecord.class);
