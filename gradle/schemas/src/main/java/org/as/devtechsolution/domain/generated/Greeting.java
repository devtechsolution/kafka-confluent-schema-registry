...
public class Greeting extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5585130063951092195L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Greeting\",\"namespace\":\"org.as.devtechsolution.domain.generated\",\"fields\":[{\"name\":\"greeting\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static org.as.devtechsolution.domain.generated.Greeting.Builder newBuilder() {
    return new org.as.devtechsolution.domain.generated.Greeting.Builder();
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static org.as.devtechsolution.domain.generated.Greeting.Builder newBuilder(org.as.devtechsolution.domain.generated.Greeting.Builder other) {
    if (other == null) {
      return new org.as.devtechsolution.domain.generated.Greeting.Builder();
    } else {
      return new org.as.devtechsolution.domain.generated.Greeting.Builder(other);
    }
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static org.as.devtechsolution.domain.generated.Greeting.Builder newBuilder(org.as.devtechsolution.domain.generated.Greeting other) {
    if (other == null) {
      return new org.as.devtechsolution.domain.generated.Greeting.Builder();
    } else {
      return new org.as.devtechsolution.domain.generated.Greeting.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Greeting>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.as.devtechsolution.domain.generated.Greeting.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.as.devtechsolution.domain.generated.Greeting other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.greeting)) {
        this.greeting = data().deepCopy(fields()[0].schema(), other.greeting);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.as.devtechsolution.domain.generated.Greeting.Builder setGreeting(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.as.devtechsolution.domain.generated.Greeting.Builder clearGreeting() {
      greeting = null;
